...
# Run for category: capital-common-countries
category_name = "capital-common-countries"
...
print(f"Results for '{category_name}' saved!")


# In[ ]:


# Run for category: capital-world
...
# Run for category: gram1-adjective-to-adverb
category_name = "gram1-adjective-to-adverb"
questions = sections[category_name]
print(f"Processing category: {category_name} ({len(questions)} questions)")
results_df = run_all_experiments(
    model=model,
...
# Run for category: gram2-opposite
category_name = "gram2-opposite"
questions = sections[category_name]
print(f"Processing category: {category_name} ({len(questions)} questions)")
results_df = run_all_experiments(
    model=model,
...
# Run for category: gram5-present-participle
category_name = "gram5-present-participle"
questions = sections[category_name]
print(f"Processing category: {category_name} ({len(questions)} questions)")
results_df = run_all_experiments(
    model=model,
...
# Run for category: gram8-plural
category_name = "gram8-plural"
questions = sections[category_name]
print(f"Processing category: {category_name} ({len(questions)} questions)")
results_df = run_all_experiments(
    model=model,
...
# Run for category: gram9-plural-verbs
category_name = "gram9-plural-verbs"
questions = sections[category_name]
print(f"Processing category: {category_name} ({len(questions)} questions)")
results_df = run_all_experiments(
    model=model,
