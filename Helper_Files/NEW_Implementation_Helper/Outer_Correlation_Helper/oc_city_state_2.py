...
# Run for category: city-in-state
category_name = "city-in-state"
questions = sections[category_name]
total = len(questions)
quarter = total // 4
part1 = questions[:quarter]
part2 = questions[quarter:2*quarter]
part3 = questions[2*quarter:3*quarter]
part4 = questions[3*quarter:]
...
part_idx = 2  # For city-in-state-2.py
chunk_questions = part2  # Use part1, part2, part3, or part4
print(f"Processing part {part_idx} of 4...")
...
final_df = pd.concat(all_results, ignore_index=True)
out_csv = f"city_in_state_results-{part_idx}.csv"
