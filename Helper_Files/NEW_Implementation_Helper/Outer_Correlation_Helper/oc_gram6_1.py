...
# Run for category: gram6-nationality-adjective
category_name = "gram6-nationality-adjective"
questions = sections[category_name]
total = len(questions)
part1 = questions[:total//3]
part2 = questions[total//3:2*total//3]
part3 = questions[2*total//3:]
...
part_idx = 1  # For gram6-1.py
chunk_questions = part1  # Use part1, part2, or part3
print(f"Processing part {part_idx} of 3...")
...
final_df = pd.concat(all_results, ignore_index=True)
out_csv = f"gram6_nationality_adjective_results-{part_idx}.csv"
