#!/bin/bash
#SBATCH --job-name=new_wordvec_measurements_currency
#SBATCH --time=2-20:00:00        # Maximum allowed time (96 hours / 4 days)
...
python new_wordvec_measurements_currency.py