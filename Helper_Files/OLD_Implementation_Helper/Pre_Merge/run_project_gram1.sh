#!/bin/bash
#SBATCH --job-name=new_wordvec_measurements_gram1
#SBATCH --time=3-00:00:00        # Maximum allowed time (96 hours / 4 days)
#SBATCH --cpus-per-task=32        # Requesting 32 CPU cores
#SBATCH --mem=30G                # Maximum available memory
...
python new_wordvec_measurements_gram1.py