#!/bin/bash
#SBATCH --job-name=new_wordvec_measurements
#SBATCH --time=1-00:00:00        # Maximum allowed time (96 hours / 4 days)
#SBATCH --cpus-per-task=32        # Requesting 32 CPU cores
#SBATCH --mem=250G                # Maximum available memory
#SBATCH --partition=msilarge      # Using the 4-day partition
...
python new_wordvec_measurements_family.py